(() => {
  ...
  if(!isFullCatalog){
    ...
    const more=document.createElement('a');more.className='catalog-more btn primary';more.href='catalog.html';more.textContent='Открыть полный каталог моделей →';grid.after(more);
